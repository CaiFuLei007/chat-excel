...
std::string ErrorMessage(ErrorCode error_code)
{
    ...
    static const std::unordered_map<int, std::string> kErrorMessageMap = {
        ...
        {static_cast<int>(ErrorCode::DB_CONFIG_INVALID), "数据库配置无效"},
        {static_cast<int>(ErrorCode::DB_UNSUPPORTED_DATABASE_TYPE), "不支持的数据库类型"},
        {static_cast<int>(ErrorCode::DB_EXECUTE_FAILED), "SQL 执行失败"},
        {static_cast<int>(ErrorCode::DB_PREPARE_FAILED), "预编译语句构建失败"},
        {static_cast<int>(ErrorCode::DB_PARAM_BIND_FAILED), "预编译语句参数绑定失败"},
        {static_cast<int>(ErrorCode::DB_RESULT_FETCH_FAILED), "查询结果获取失败"},
        {static_cast<int>(ErrorCode::DB_TRANSACTION_FAILED), "事务操作失败"},
        {static_cast<int>(ErrorCode::DB_SQL_EMPTY), "SQL 语句为空"},
        {static_cast<int>(ErrorCode::DB_SQL_INVALID), "SQL 语句无效或类型不受支持"},
        ...
        {static_cast<int>(ErrorCode::DB_FILE_RPC_ERROR), "文件子服务 RPC 调用失败"},
        {static_cast<int>(ErrorCode::DB_LOCAL_FILE_ERROR), "数据库子服务本地文件操作失败"},
        {static_cast<int>(ErrorCode::DB_FDFS_DOWNLOAD_ERROR), "从 FastDFS 下载数据库文件失败"},
        {static_cast<int>(ErrorCode::DB_SERIALIZE_ERROR), "数据 JSON 序列化或反序列化失败"},
        {static_cast<int>(ErrorCode::DB_SERVICE_SESSION_ID_EMPTY), "数据库子服务请求参数错误 : 会话 ID 为空"},
        {static_cast<int>(ErrorCode::DB_SERVICE_USER_ID_EMPTY), "数据库子服务请求参数错误 : 用户 ID 为空"},
        {static_cast<int>(ErrorCode::DB_SERVICE_CONNECTION_ID_EMPTY), "数据库子服务请求参数错误 : 数据库连接 ID 为空"},
        {static_cast<int>(ErrorCode::DB_SERVICE_TABLE_NAME_EMPTY), "数据库子服务请求参数错误 : 表名为空"},
        {static_cast<int>(ErrorCode::DB_SERVICE_SQL_EMPTY), "数据库子服务请求参数错误 : SQL 语句为空"},
        {static_cast<int>(ErrorCode::DB_SERVICE_INTERNAL_ERROR), "数据库子服务内部错误"},
        {static_cast<int>(ErrorCode::DB_SERVICE_TABLE_NAMES_EMPTY), "数据库子服务请求参数错误 : 要删除的表名列表为空"},
        {static_cast<int>(ErrorCode::DB_SERVICE_WORKSHEET_DATA_EMPTY), "数据库子服务请求参数错误 : WorkSheet 数据缺失"},
